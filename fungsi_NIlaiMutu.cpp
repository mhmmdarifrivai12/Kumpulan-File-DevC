...
float hitungtotalnilai(float tugas,float kuis,int uts, int uas);
char konversinilaimutu(float hasil);

float hitungtotalnilai(float tugas, float kuis, float uts, float uas){
	float
}
